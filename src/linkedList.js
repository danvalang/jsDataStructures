...
function Node(data, references) {
	var _ = require('lodash');
	return({
		next: (_.has(references, "next") && references.next instanceof Node ? references.next : null),
		previous: (_.has(references, "previous") && references.previous instanceof Node ? references.previous : null),
		data: data,
